...
public class Main {
	...
	public static void main(String[] args) {
		...
		HADRThirdUser HADRThirdUser = new HADRThirdUser("DR_admin", "**passwd**", args[0], args[1], args[2]);
	 ...
	 * @param HADRThirdUser
	 */
	private static void testAsyncToSync(HADRThirdUser HADRThirdUser) {
		HADRThirdUser.toAsync();
		HADRThirdUser.toSync();
	}

	private static void RemoteToLocal(HADRThirdUser HADRThirdUser) {
		HADRThirdUser.toRemote();
		HADRThirdUser.toLocal();
	}
}
